...
class CreateChequesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('cheques', function (Blueprint $table) {
            ...
            $table->date("transfer_date")->nullable()->comment("Alınan çekin müşteriye verildiği tarih.");
            $table->integer("type")->comment("0-Çek 1-Senet");
            $table->string("description")->nullable();
            $table->string("document_no")->nullable();
            $table->string("bank_name")->nullable();
            $table->string("bank_branch")->nullable();
            $table->date("date")->comment("Çekin İşlem Tarihi");
            $table->date("payment_date")->comment("Çekin Ödeme tarihi (Vade)");
