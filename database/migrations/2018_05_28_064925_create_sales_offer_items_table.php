...
class CreateSalesOfferItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sales_offer_items', function (Blueprint $table) {
            $table->increments('id');
            $table->integer("sales_offer_id")->unsigned();
            ...
            $table->foreign("sales_offer_id")->on("sales_offers")->references("id")->onDelete("cascade");
        });
    }
