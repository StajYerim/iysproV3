...
Route::group(['prefix'=>'{company_id}/finance','middleware'=>'not.admin'],function() {
    ...
    Route::post("accounts/{id}/hidden_users","Modules\Finance\BankAccountsController@hidden_users_send")->name("finance.accounts.hidden_users");
    ...
    Route::post("expenses/delete","Modules\Finance\ExpensesController@expenses_delete")->name("finance.expenses.delete");
