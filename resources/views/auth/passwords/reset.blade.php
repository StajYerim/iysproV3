...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ trans("sentence.reset_password") }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.request') }}">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">{{ trans("word.password") }}</label>
