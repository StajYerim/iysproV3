                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu"  style="   right: 158px;top: 5px;">
                                    @foreach($langs as $lang)
                                        <li><a tabindex="-1" target="_blank" href="{{route("sales.orders.pdf",[aid(),$order->id,"download",$lang->lang_code])}}" > <img src="https://dev.iyspro.com/img/blank.gif" class="flag flag-{{$lang->lang_code == "en" ? "us":$lang->lang_code}}"> {{$lang->name}}</a></li>
                                    @endforeach
                                </ul>
                            </li>
                            <li class="">
                                        ...
                                        <table class="table table-hover table-condensed table-no-padding">
                                            ...
                                            <tr v-for="item in items" v-bind:class="item.waybill">
                                                ...
                                                <td style="text-align:right">@{{ item.price }} <i
                                                            class='fa fa-{{$order->fa_currency}}'></i></td>
                                        ...
                                        <div class="col-sm-6">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:right">
                                                        <div class="bottom-info"
                                                            ...
                                                            <i class="fa fa-{{$order->fa_currency}}"></i></div>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align:right">
                                                            <div class="bottom-info" style="color:#2AC!important">1 <i
                                                                        class="fa fa-{{$order->fa_currency}}"></i>
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="pull-right">@{{ remaining }} <i class="fa fa-{{$order->fa_currency}}"></i></span></td>
                                                </tr>
                                                </tfoot>
                                                <tbody>
                                                    ...
                                                    <tr v-for="item in collect_items"   class="success" style="cursor: pointer;" @click="redirect(item.id,item.type)">
                                                        ...
                                                        <td> <span class="pull-right">@{{item.amount}} <i class="fa fa-{{$order->fa_currency}}"></i></span></td>
                                                    </tr>
