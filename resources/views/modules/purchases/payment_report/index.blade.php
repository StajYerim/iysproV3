                    ...
                    <div class="jarviswidget well" id="wid-id-3" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                        <div class="widget-body">
                            <div class="widget-body-toolbar st">
                                <div class="row">
                                    <div class="col-sm-8" ><h4>{{ trans('sentence.payment_reports') }}</h4></div>
                            ...
                            <div class="row">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="col-sm-4">
                                            <div class="text-center"><h6><b>{{ trans('sentence.overdue_payments') }}</b></h6></div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="text-center"><h6><b>{{ trans('sentence.total_payment') }}</b></h6></div>
                                            <div class="text-center" style="font-size:30px;color:#2AC!important">{{$total_payment}}<b> <small class="note"><i class="fa fa-try"></i> </small></b></div>
                                ...
                                <div class="col-sm-12">
                                    <table id="datatable_col_reorder" class="table table-striped table-bordered table-hover" width="100%">
                                        <thead>
                                        <tr>
                                            <th width="15%">{{ trans('sentence.payment_date') }}</th>
                                        ...
                                        <tbody>
                                        @foreach($export_collect["purchases_orders"] as $order)
                                            @if($order->remaining != "0,00")
                                        <tr style="cursor:pointer" onclick="window.location.href='{{route("purchases.orders.show",[aid(),$order->id])}}'">
                                        ...
                                        @foreach($export_collect["cheques"] as $cheque)
                                            @if ($cheque->cheques_status == 0 && $cheque->show_button == "verilen" )
