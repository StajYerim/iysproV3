                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu"  style="   right: 158px;top: 5px;">
                                    @foreach($langs as $lang)
                                        <li><a tabindex="-1" target="_blank" href="{{route("purchases.offers.pdf",[aid(),$offer->id,"download",$lang->lang_code])}}" > <img src="https://dev.iyspro.com/img/blank.gif" class="flag flag-{{$lang->lang_code == "en" ? "us":$lang->lang_code}}"> {{$lang->name}}</a></li>
                                    @endforeach
                                </ul>
                            </li>
                                            ...
                                            <table class="table table-condensed table-striped" width="100%" border="0">
                                                ...
                                                @if( $offer->discount_value != "0,00")
                                                    <tr>
                                                        ...
                                                        <td style="text-align:right">
                                                            <div class="bottom-info">{{$offer->discount_value}} <i
                                                                        class="fa fa-{{$offer->fa_currency}}"></i></div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td style="text-align:right">
                                                            <div class="bottom-info">{{get_money(money_db_format($offer->sub_total)-money_db_format($offer->discount_value))}} <i
                                                                        class="fa fa-{{$offer->fa_currency}}"></i></div>
                                                        </td>
                                                    </tr>
                                                @endif
